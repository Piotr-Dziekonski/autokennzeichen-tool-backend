...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Mai 2022 um 10:32
...
-- Datenbank: `kfz`
--
CREATE DATABASE IF NOT EXISTS `kfz` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `kfz`;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `kennzeichnung`
--

DROP TABLE IF EXISTS `kennzeichnung`;
CREATE TABLE `kennzeichnung` (
  `Ortskuerzel` varchar(45) NOT NULL,
  `Ursprung` varchar(45) NOT NULL,
  `Landkreis` longtext NOT NULL,
  `Bundesland` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Daten für Tabelle `kennzeichnung`
--

INSERT INTO `kennzeichnung` (`Ortskuerzel`, `Ursprung`, `Landkreis`, `Bundesland`) VALUES
('A', 'Augsburg', 'Stadt Augsburg, Landkreis Augsburg', 'Bayern'),
...
('AC', 'AaChen', 'Städteregion Aachen', 'Nordrhein-Westfalen'),
...
('AIC', 'AIChach', 'Landkreis Aichach-Friedberg', 'Bayern'),
('AK', 'AltenKirchen', 'Landkreis Altenkirchen (Westerwald)', 'Rheinland-Pfalz'),
('ALF', 'ALFeld', 'Landkreis Hildesheim', 'Niedersachsen'),
('ALZ', 'ALZenau', 'Landkreis Aschaffenburg', 'Bayern'),
('AM', 'AMberg', 'Stadt Amberg', 'Bayern'),
('AN', 'ANsbach', 'Stadt Ansbach, Landkreis Ansbach', 'Bayern'),
('ANA', 'ANnAberg', 'Erzgebirgskreis', 'Sachsen'),
('ANG', 'ANGermünde', 'Landkreis Uckermark', 'Brandenburg'),
('ANK', 'ANKlam', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
('AÖ', 'AltÖtting', 'Landkreis Altötting', 'Bayern'),
('AP', 'APolda', 'Landkreis Weimarer Land', 'Thüringen'),
('APD', 'APolDa', 'Landkreis Weimarer Land', 'Thüringen'),
('ARN', 'ARNstadt', 'Ilm-Kreis', 'Thüringen'),
...
('BBL', 'BrandenBurgische Landesregierung', 'Brandenburg, Landesregierung, Landtag und Polizei', 'Brandenburg'),
...
('BED', 'Brand-ErbisDorf', 'Landkreis Mittelsachsen', 'Sachsen'),
('BER', 'BERnau', 'Landkreis Barnim', 'Brandenburg'),
('BF', 'BurgsteinFurt', 'Kreis Steinfurt', 'Nordrhein-Westfalen'),
...
('BID', 'BIeDenkopf', 'Landkreis Marburg-Biedenkopf', 'Hessen'),
...
('BKS', 'BernKaStel', 'Landkreis Bernkastel-Wittlich', 'Rheinland-Pfalz'),
...
('BRV', 'BRemerVörde', 'Landkreis Rotenburg (Wümme)', 'Niedersachsen'),
('BS', 'BraunSchweig', 'Stadt Braunschweig, Polizeidirektion Braunschweig (PD 100–9999)', 'Niedersachsen'),
...
('BW', 'Bundes-Wasserstraßen- und Schifffahrtsverwalt', 'Wasserstraßen- und Schifffahrtsverwaltung des Bundes', 'bundesweit'),
('BWL', 'Baden-Württembergischer Landtag', 'Baden-Württemberg, Landesregierung, Landtag und Polizei', 'Baden-Württemberg'),
...
('COC', 'COChem', 'Landkreis Cochem-Zell', 'Rheinland-Pfalz'),
...
('CW', 'CalW', 'Landkreis Calw', 'Baden-Württemberg'),
...
('DAU', 'DAUn', 'Landkreis Vulkaneifel', 'Rheinland-Pfalz'),
...
('DLG', 'DilLinGen', 'Landkreis Dillingen an der Donau', 'Bayern'),
('DM', 'DemMin', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
...
('DÜW', 'DÜrkheim an der Weinstraße', 'Landkreis Bad Dürkheim', 'Rheinland-Pfalz'),
('DW', 'DippoldisWalde', 'Landkreis Sächsische Schweiz-Osterzgebirge', 'Sachsen'),
('DZ', 'DelitZsch', 'Landkreis Nordsachsen', 'Sachsen'),
...
('EBN', 'EBerN', 'Landkreis Haßberge', 'Bayern'),
('EBS', 'EBermannStadt', 'Landkreis Forchheim, Landkreis Kulmbach (A–M 1–999), Landkreis Bayreuth (N–Z 1–999)', 'Bayern'),
('ECK', 'ECKernförde', 'Kreis Rendsburg-Eckernförde', 'Schleswig-Holstein'),
('ED', 'ErDing', 'Landkreis Erding', 'Bayern'),
('EE', 'Elbe, Elster', 'Landkreis Elbe-Elster', 'Brandenburg'),
...
('EIN', 'EINbeck', 'Landkreis Northeim', 'Niedersachsen'),
...
('ERB', 'ERBach', 'Odenwaldkreis', 'Hessen'),
('ERH', 'ERlangen, Höchstadt', 'Landkreis Erlangen-Höchstadt', 'Bayern'),
...
('ESB', 'ESchenBach', 'Landkreis Neustadt an der Waldnaab, Landkreis Amberg-Sulzbach (B, F, G, I, O und Q 1–999), Landkreis Bayreuth (AT, BT, CT, DT, ... YT und ZT 1–99), Landkreis Nürnberger Land (N 1–999)', 'Bayern'),
('ESW', 'ESchWege', 'Werra-Meißner-Kreis', 'Hessen'),
('EU', 'EUskirchen', 'Kreis Euskirchen', 'Nordrhein-Westfalen'),
('EW', 'EbersWalde', 'Landkreis Barnim', 'Brandenburg'),
('F', 'Frankfurt', 'Stadt Frankfurt am Main', 'Hessen'),
('FB', 'FriedBerg', 'Wetteraukreis', 'Hessen'),
('FD', 'FulDa', 'Landkreis Fulda', 'Hessen'),
('FDB', 'FrieDBerg', 'Landkreis Aichach-Friedberg', 'Bayern'),
('FDS', 'FreuDenStadt', 'Landkreis Freudenstadt', 'Baden-Württemberg'),
...
('FRG', 'FReyung, Grafenau', 'Landkreis Freyung-Grafenau', 'Bayern'),
('FRI', 'FRIesland', 'Landkreis Friesland', 'Niedersachsen'),
...
('FW', 'FürstenWalde', 'Landkreis Oder-Spree', 'Brandenburg'),
...
('GAP', 'GArmisch-Partenkirchen', 'Landkreis Garmisch-Partenkirchen', 'Bayern'),
...
('GK', 'GeilenKirchen', 'Kreis Heinsberg', 'Nordrhein-Westfalen'),
...
('GN', 'GelnhauseN', 'Main-Kinzig-Kreis ohne die Stadt Hanau', 'Hessen'),
...
('GS', 'GoSlar', 'Landkreis Goslar', 'Niedersachsen'),
...
('GW', 'GreifsWald', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
...
('HAS', 'HASsfurt', 'Landkreis Haßberge', 'Bayern'),
('HB', 'Hansestadt Bremen', 'Stadt Bremen, Senat und Bürgerschaft, Stadt Bremerhaven (A–Z 1000–9999)', 'Bremen'),
('HBN', 'HildBurghauseN', 'Landkreis Hildburghausen', 'Thüringen'),
('HBS', 'HalBerStadt', 'Landkreis Harz', 'Sachsen-Anhalt'),
('HC', 'HainiChen', 'Landkreis Mittelsachsen', 'Sachsen'),
('HCH', 'HeCHingen', 'Zollernalbkreis, Landkreis Freudenstadt (YQ, QY, YV, VY und ZQ 100 bis 999)', 'Baden-Württemberg'),
...
('HE', 'HElmstedt', 'Landkreis Helmstedt', 'Niedersachsen'),
...
('HGW', 'Hansestadt GreifsWald', 'Stadt Greifswald (große kreisangehörige Stadt im Landkreis Vorpommern-Greifswald)', 'Mecklenburg-Vorpommern'),
...
('HMÜ', 'Hann. MÜnden', 'Landkreis Göttingen ohne die Stadt Göttingen', 'Niedersachsen'),
('HN', 'HeilbronN', 'Stadt Heilbronn, Landkreis Heilbronn (AA–MZ 100–9999 und NA–ZZ 100–999)', 'Baden-Württemberg'),
('HO', 'HOf', 'Stadt Hof, Landkreis Hof (AA–ZZ 100–9999)', 'Bayern'),
('HOG', 'HOfGeismar', 'Landkreis Kassel', 'Hessen'),
('HOH', 'HOfHeim', 'Landkreis Haßberge', 'Bayern'),
('HOL', 'HOLzminden', 'Landkreis Holzminden', 'Niedersachsen'),
('HOM', 'HOMburg', 'Saarpfalz-Kreis ohne die Stadt St. Ingbert', 'Saarland'),
('HOR', 'HORb', 'Landkreis Freudenstadt', 'Baden-Württemberg'),
('HÖS', 'HÖchStadt', 'Landkreis Erlangen-Höchstadt', 'Bayern'),
('HOT', 'HOhensTein', 'Landkreis Zwickau', 'Sachsen'),
...
('HST', 'Hansestadt STralsund', 'Stadt Stralsund (große kreisangehörige Stadt im Landkreis Vorpommern-Rügen)', 'Mecklenburg-Vorpommern'),
('HU', 'HanaU', 'Stadt Hanau (Sonderstatusstadt im Main-Kinzig-Kreis), Main-Kinzig-Kreis (übriges Kreisgebiet)', 'Hessen'),
('HV', 'HaVelberg', 'Landkreis Stendal', 'Sachsen-Anhalt'),
('HVL', 'HaVelLand', 'Landkreis Havelland', 'Brandenburg'),
('HWI', 'Hansestadt WIsmar', 'Stadt Wismar (große kreisangehörige Stadt im Landkreis Nordwestmecklenburg)', 'Mecklenburg-Vorpommern'),
('HX', 'HöXter', 'Kreis Höxter', 'Nordrhein-Westfalen'),
('HY', 'HoYerswerda', 'Landkreis Bautzen', 'Sachsen'),
('HZ', 'HarZ', 'Landkreis Harz', 'Sachsen-Anhalt'),
('IGB', 'InGBert', 'Stadt St. Ingbert (Mittelstadt im Saarpfalz-Kreis)', 'Saarland'),
...
('KL', 'KaisersLautern', 'Stadt Kaiserslautern, Landkreis Kaiserslautern (AA–ZZ 100–999)', 'Rheinland-Pfalz'),
...
('KN', 'KoNstanz', 'Landkreis Konstanz ohne die Gemeinde Büsingen am Hochrhein', 'Baden-Württemberg'),
...
('KS', 'KasSel', 'Landkreis Kassel und Stadt Kassel', 'Hessen'),
...
('KW', 'Königs Wusterhausen', 'Landkreis Dahme-Spreewald', 'Brandenburg'),
('KY', 'KYritz', 'Landkreis Ostprignitz-Ruppin', 'Brandenburg'),
('KYF', 'KYFfhäuser', 'Kyffhäuserkreis', 'Thüringen'),
('L', 'Leipzig', 'Sachsen', 'Stadt Leipzig (A–T und AA–TZ), Landkreis Leip'),
...
('LEO', 'LEOnberg', 'Landkreis Böblingen', 'Baden-Württemberg'),
('LER', 'LEeR', 'Landkreis Leer', 'Niedersachsen'),
('LEV', 'LEVerkusen', 'Stadt Leverkusen', 'Nordrhein-Westfalen'),
('LF', 'LauFen', 'Landkreis Berchtesgadener Land, Landkreis Altötting (C 1–999, E 1–500, I, J, M, O, Q und V 1–999), Landkreis Traunstein (B, F und G 1–999, DH 1–100, FZ, GH und KQ 1–999, LU 1–200, RW 1–999, TK 1–100, TS 1–999, VW 200–400 sowie WW, XX und ZZ 1–999)', 'Bayern'),
('LG', 'LüneburG', 'Landkreis Lüneburg', 'Niedersachsen'),
...
('LOS', 'Landkreis Oder-Spre', 'Landkreis Oder-Spree', 'Brandenburg'),
...
('LSN', 'Landtag SachseN', 'Sachsen, Landesregierung und Landtag', 'Sachsen'),
...
('LWL', 'LudWigsLust', 'Landkreis Ludwigslust-Parchim', 'Mecklenburg-Vorpommern'),
('M', 'München', 'Landkreis München, Stadt München (AA–ZZ 100–9999)', 'Bayern'),
('MA', 'MAnnheim', 'Stadt Mannheim', 'Baden-Württemberg'),
('MAB', 'MArienBerg', 'Erzgebirgskreis', 'Sachsen'),
('MAI', 'MAInburg', 'Landkreis Kelheim, Landkreis Landshut (B, F, G, I, O und Q 1–9999)', 'Bayern'),
...
('MEK', 'Mittlerer ErzgebirgsKreis', 'Erzgebirgskreis', 'Sachsen'),
...
('MSE', 'Mecklenburgische SEenplatte', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
('MSH', 'Mansfeld, SüdHarz', 'Landkreis Mansfeld-Südharz', 'Sachsen-Anhalt'),
('MSP', 'Main, SPessart', 'Landkreis Main-Spessart', 'Bayern'),
('MST', 'Mecklenburg-STrelitz', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
...
('MVL', 'Mecklenburg-Vorpommerscher Landtag', 'Mecklenburg-Vorpommern, Landesregierung, Landtag und Polizei', 'Mecklenburg-Vorpommern'),
...
('N', 'Nürnberg', 'Landkreis Nürnberger Land (A–Z 1–999), Stadt Nürnberg (A–Z 1000–9999 und AA–ZZ 100–9999)', 'Bayern'),
...
('NB', 'NeuBrandenburg', 'Stadt Neubrandenburg (große kreisangehörige Stadt im Landkreis Mecklenburgische Seenplatte)', 'Mecklenburg-Vorpommern'),
...
('NES', 'NEustadt an der Saale', 'Landkreis Rhön-Grabfeld', 'Bayern'),
('NEW', 'NEustadt an der Waldnaab', 'Landkreis Neustadt an der Waldnaab', 'Bayern'),
...
('NK', 'NeunKirchen', 'Landkreis Neunkirchen', 'Saarland'),
('NL', 'Niedersächsischer Landtag', 'Niedersachsen, Landesregierung und Landtag', 'Niedersachsen'),
...
('NVP', 'NordVorPommern', 'Landkreis Vorpommern-Rügen ohne die Stadt Stralsund', 'Mecklenburg-Vorpommern'),
...
('NZ', 'NeustrelitZ', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
...
('OBB', 'OBernBurg', 'Landkreis Miltenberg', 'Bayern'),
...
('OF', 'OFfenbach', 'Landkreis Offenbach und Stadt Offenbach am Main', 'Hessen'),
...
('OHV', 'OberHaVel', 'Landkreis Oberhavel', 'Brandenburg'),
...
('OTW', 'OTtWeiler', 'Landkreis Ottweiler', 'Saarland'),
('OVI', 'OberVIechtach', 'Landkreis Schwandorf', 'Bayern'),
('OVL', 'OberVogtLand', 'Vogtlandkreis', 'Sachsen'),
('OVP', 'OstVorPommern', 'Landkreis Ostvorpommern', 'Mecklenburg-Vorpommern'),
...
('PE', 'PEine', 'Landkreis Peine', 'Niedersachsen'),
...
('PW', 'PaseWalk', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
...
('REH', 'REHau', 'Landkreis Hof, Landkreis Wunsiedel im Fichtelgebirge (A, E, F, H, J, M, N, P, R, S, V und X 1–999, AA, FF, GG, OO und ZZ 100–999 sowie AU 900–999)', 'Bayern'),
('REI', 'REIchenhall', 'Landkreis Berchtesgadener Land', 'Bayern'),
('RG', 'Riesa, Großenhain', 'Landkreis Meißen', 'Sachsen'),
('RH', 'RotH', 'Landkreis Roth', 'Bayern'),
...
('RM', 'Röbel/Müritz', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
...
('ROF', 'ROtenburg an der Fulda', 'Landkreis Hersfeld-Rotenburg', 'Hessen'),
...
('RP', 'Rhein-Pfalz', 'Rhein-Pfalz-Kreis', 'Rheinland-Pfalz'),
('RPL', 'Rheinland-Pfälzischer Landtag', 'Rheinland-Pfalz, Landesregierung, Landtag und Polizei', 'Rheinland-Pfalz'),
('RS', 'RemScheid', 'Stadt Remscheid', 'Nordrhein-Westfalen'),
('RSL', 'RosSLau', 'Stadt Dessau-Roßlau', 'Sachsen-Anhalt'),
('RT', 'ReuTlingen', 'Landkreis Reutlingen', 'Baden-Württemberg'),
('RU', 'RUdolstadt', 'Landkreis Saalfeld-Rudolstadt', 'Thüringen'),
('RÜD', 'RÜDesheim', 'Rheingau-Taunus-Kreis', 'Hessen'),
('RÜG', 'RÜGen', 'Landkreis Vorpommern-Rügen', 'Mecklenburg-Vorpommern'),
('RV', 'RaVensburg', 'Landkreis Ravensburg', 'Baden-Württemberg'),
...
('SAL', 'SAarländischer Landtag', 'Saarland, Landesregierung, Landtag und Polizei', 'Saarland'),
...
('SDL', 'StenDaL', 'Landkreis Stendal', 'Sachsen-Anhalt'),
...
('SEF', 'SchEinFeld', 'Landkreis Neustadt an der Aisch-Bad Windsheim', 'Bayern'),
...
('SLG', 'SauLGau', 'Landkreis Saulgau', 'Baden-Württemberg'),
('SLK', 'SalzLandKreis', 'Salzlandkreis', 'Sachsen-Anhalt'),
('SLN', 'SchmölLN', 'Landkreis Altenburger Land', 'Thüringen'),
('SLS', 'SaarLouiS', 'Landkreis Saarlouis', 'Saarland'),
('SLÜ', 'SchLÜchtern', 'Main-Kinzig-Kreis ohne die Stadt Hanau', 'Hessen'),
...
('SON', 'SONneberg', 'Landkreis Sonneberg', 'Thüringen'),
...
('SÜW', 'SÜdliche Weinstraße', 'Landkreis Südliche Weinstraße', 'Rheinland-Pfalz'),
...
('TR', 'TRier', 'Landkreis Trier-Saarburg und Stadt Trier', 'Rheinland-Pfalz'),
...
('UEM', 'UEckerMünde', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
...
('VB', 'VogelsBerg', 'Vogelsbergkreis', 'Hessen'),
('VEC', 'VEChta', 'Landkreis Vechta', 'Niedersachsen'),
('VER', 'VERden', 'Landkreis Verden', 'Niedersachsen'),
('VG', 'Vorpommern, Greifswald', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
...
('VK', 'VölKlingen', 'Stadt Völklingen (Mittelstadt im Regionalverband Saarbrücken)', 'Saarland'),
('VOH', 'VOHenstrauß', 'Landkreis Neustadt an der Waldnaab', 'Bayern'),
('VR', 'Vorpommern, Rügen', 'Landkreis Vorpommern-Rügen ohne die Stadt Stralsund', 'Mecklenburg-Vorpommern'),
...
('WAN', 'WANne', 'Stadt Herne', 'Nordrhein-Westfalen'),
('WAR', 'WARburg', 'Kreis Höxter', 'Nordrhein-Westfalen'),
...
('WG', 'WanGen', 'Landkreis Ravensburg', 'Baden-Württemberg'),
...
('WIN', 'aus der Serie \"Dark\"', 'Winden (fiktiver Ort)', 'Filmproduktion'),
...
('WLG', 'WoLGast', 'Landkreis Vorpommern-Greifswald ohne die Stadt Greifswald', 'Mecklenburg-Vorpommern'),
...
('WND', 'WeNDel', 'Landkreis St. Wendel', 'Saarland'),
...
('WRN', 'WaReN', 'Landkreis Mecklenburgische Seenplatte ohne die Stadt Neubrandenburg', 'Mecklenburg-Vorpommern'),
...
('WSW', 'WeisSWasser', 'Landkreis Görlitz', 'Sachsen'),
...
('WÜM', 'WaldMÜnchen (mit einem Buchstabendreher)', 'Landkreis Cham', 'Bayern'),
('WUN', 'WUNsiedel', 'Landkreis Wunsiedel im Fichtelgebirge', 'Bayern'),
...
('X', 'willkürlich gewählt', 'Internationale Hauptquartiere (NATO)', 'bundesweit'),
('Y', 'willkürlich gewählt', 'Bundeswehr', 'bundesweit'),
('Z', 'Zwickau', 'Landkreis Zwickau', 'Sachsen'),
('ZE', 'ZErbst', 'Landkreis Anhalt-Bitterfeld', 'Sachsen-Anhalt'),
('ZEL', 'ZELl', 'Landkreis Cochem-Zell', 'Rheinland-Pfalz'),
('ZI', 'ZIttau', 'Landkreis Görlitz', 'Sachsen'),
('ZIG', 'ZIeGenhain', 'Schwalm-Eder-Kreis', 'Hessen'),
('ZP', 'ZschoPau', 'Erzgebirgskreis', 'Sachsen'),
('ZR', 'ZeulenRoda', 'Landkreis Greiz', 'Thüringen'),
('ZW', 'ZWeibrücken', 'Stadt Zweibrücken, Landkreis Südwestpfalz (AA–ZZ 1–99)', 'Rheinland-Pfalz'),
